...
export default function About() {
    ...
    return (
        <section className="max-w-4xl flex items-center justify-center py-12 fade-in-move-up">
            {/* Floating Div with Rounded Corners */}
            <div
                ref={sectionRef} // Apply ref to the inner div for scroll tracking
                className="w-full p-8 bg-white dark:bg-gray-800 bg-opacity-80 dark:bg-opacity-80 rounded-lg shadow-lg transition-colors duration-500 ease-in-out"
